...
if( !function_exists('ts_template_social_sharing') ){
	...
	<ul class="ts-social-sharing">
		...
		<li class="twitter">
			<a href="https://twitter.com/intent/tweet?text=<?php echo esc_url(get_permalink()); ?>" target="_blank"><i class="fa fa-twitter"></i></a>
		</li>
...
if( !function_exists('ts_product_social_sharing') ){
	function ts_product_social_sharing(){
		...
		<ul class="ts-product-social-sharing">
			...
			<li class="twitter">
				<a href="https://twitter.com/intent/tweet?text=<?php echo esc_url(get_permalink()); ?>" target="_blank"><i class="fa fa-twitter"></i><?php esc_html_e('Tweet', 'themesky') ?></a>
			</li>
