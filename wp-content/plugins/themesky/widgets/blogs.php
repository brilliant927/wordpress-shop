...
if( !class_exists('TS_Blogs_Widget') ){
	class TS_Blogs_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			$show_view 			= empty($instance['show_view'])?0:$instance['show_view'];
						...
						<?php endif; ?>
							<li>
								...
								<?php if( $post_format != 'quote' ): ?>
									...
									<?php if( $show_date || $show_author || $show_comment || $show_view ): ?>
									<div class="entry-meta">
										...
										<?php if( $show_comment && function_exists('boxshop_post_comment_count') ): ?>
										<span class="comment">
										...
										<?php if( $show_view && function_exists('ts_post_view_count') ): ?>
										<span class="view">
									...
									<?php if( $show_excerpt && function_exists('boxshop_the_excerpt_max_words') ): ?>
										<div class="excerpt">
											<?php boxshop_the_excerpt_max_words($excerpt_words, $post); ?>
										</div>
									<?php endif; ?>
		...
		?>
			...
			<p>
				<input type="checkbox" id="<?php echo $this->get_field_id('show_view'); ?>" name="<?php echo $this->get_field_name('show_view'); ?>" value="1" <?php echo ($instance['show_view'])?'checked':''; ?> />
				<label for="<?php echo $this->get_field_id('show_view'); ?>"><?php esc_html_e('Show post view', 'themesky'); ?></label>
			</p>
