...
function boxshop_register_required_plugins(){
    ...
    $plugins = array(
		...
		,array(
            'name'                => 'WooCommerce'
            ,'slug'               => 'woocommerce'
			,'source'             => 'https://downloads.wordpress.org/plugin/woocommerce.5.6.0.zip'
            ,'required'           => true
			,'version'            => '5.6.0'
            ,'external_url'       => ''
        )
		...
		,array(
            'name'                => 'Contact Form 7'
            ,'slug'               => 'contact-form-7'
			,'source'             => 'https://downloads.wordpress.org/plugin/contact-form-7.5.4.2.zip'
            ,'required'           => false
			,'version'            => '5.4.2'
            ,'external_url'       => ''
        )
		...
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-wishlist.3.1.0.zip'
            ,'required'           => false
			,'version'            => '3.1.0'
            ,'external_url'       => ''
        )
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-compare.2.6.0.zip'
            ,'required'           => false
			,'version'            => '2.6.0'
            ,'external_url'       => ''
        )
